...
[source,cypher]
----
WITH '09/17/2021 08:30' as sessionDetails
RETURN apoc.temporal.toZonedTemporal(sessionDetails,'MM/dd/yyyy HH:mm') as formattedString;
----

[source,cypher]
----
WITH 'Fri Sep 17 09:30:00 -0600 2021' as sessionEnd
...
[source,cypher]
----
WITH datetime(‘2021-09-17T07:30:00’) as kcdcStart
...
[source,cypher]
----
WITH datetime('2021-09-17T08:30:00') as kcdcStart
RETURN duration.inSeconds(kcdcStart, datetime()).hours as hours, duration.inSeconds(kcdcStart, datetime()).minutesOfHour as minutes;
----
...
[source,cypher]
----
WITH datetime('2021-09-18T00:00:00') as weekend
RETURN duration.inSeconds(datetime(), weekend).hours as timeTilWeekend;
----

[source,cypher]
----
WITH datetime('2021-09-30T23:59:59') as eom
